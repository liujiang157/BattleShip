...
public class Missile {
    ...
    private int shipID;//发射这发炮弹的船的id
    ...
    public Missile(int shipID,int x, int y, boolean isEnemy, Direction direction, ShipClient shipClient) {
        this.shipID=shipID;
        this.x = x;
        this.y = y;
    ...
    public boolean hitShip(Ship ship){
        ...
        //炮弹活着并且船活着并且被敌方船击中了
        if(this.isLive&&ship.isLive()&&getRectangle().intersects(ship.getRectangle())&&this.shipID!=ship.getShipID()){
            //减去20的生命值
